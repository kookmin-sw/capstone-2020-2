      ...
      Logout
			...
			<Grid container spacing={2} id="trialOption">
				<Grid item xs={4}>
						...
						<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'happy'} }}>
							<Button
								value ="happy"
								color="primary"
								variant="contained"
					...
					<Grid item xs={4}>
					<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'sad'} }}>
							<Button
							value ="sad"
								color="primary"
								variant="contained"
					...
					<Grid item xs={4}>
					<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'angry'} }}>
							<Button
							value ="angry"
								color="primary"
								variant="contained"
					...
					<Grid item xs={4}>
					<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'disgust'} }}>
							<Button
							value ="disgust"
								color="primary"
								variant="contained"
					...
					<Grid item xs={4}>
					<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'fear'} }}>
							<Button
							value ="fear"
								color="primary"
								variant="contained"
					...
					<Grid item xs={4}>
					<Link to={{ pathname: '/VideoPlay', state: { emotionTag: 'neutral'} }}>
							<Button
							value ="neutral"
								color="primary"
								variant="contained"
